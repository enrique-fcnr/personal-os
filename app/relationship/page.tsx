...
import CriticalDates from "@/components/relationship/critical-dates";
import WeeklyIntentions from "@/components/relationship/weekly-intentions";
import RoleIdeas from "@/components/relationship/role-ideas";
            ...
            <div className="flex justify-between items-end mb-8">
              <div>
                <h2 className="font-bayon text-5xl text-white uppercase tracking-wide leading-none">
                  Terminal de Vínculos
                </h2>
                <p className="font-inter text-white/40 text-sm mt-2">
                  Relacionamentos · Intenções · Memórias
                </p>
              </div>
              <div className="text-right">
                ...
                <p className="font-bayon text-2xl text-brand-orange">4 ideias</p>
              </div>
            </div>

            {/* Bento grid */}
            <div className="grid grid-cols-12 gap-5">
              {/* Row 1: Intentions + Critical dates */}
